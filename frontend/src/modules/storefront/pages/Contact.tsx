 ...
 * PAGINA DE CONTACTO
 *
 * Formulario de contacto con datos reales de empresa desde configuracion.
 * Incluye mapa funcional de Google Maps.
 */
...
export default function Contact() {
  ...
  // Cargar datos de empresa desde endpoint publico /storefront/empresa
  useEffect(() => {
    const cargarEmpresa = async () => {
      try {
        ...
        console.warn('[Contact] No se pudo cargar datos de empresa:', error);
      } finally {
  ...
  const telefonoEmpresa = empresa?.telefono || '+51 999 888 777';
  const emailEmpresa = empresa?.email || 'hola@newhype.com';
  const direccionEmpresa = empresa?.direccion || 'Av. La Marina 2500, Lima';
  const nombreEmpresa = empresa?.nombreComercial || 'New Hype';

  // Generar URL del mapa con la direccion de la empresa
  const mapQuery = encodeURIComponent(direccionEmpresa);
  const mapEmbedUrl = `https://www.google.com/maps?q=${mapQuery}&output=embed`;

  // Generar link de WhatsApp con el telefono de la empresa
  const telefonoLimpio = telefonoEmpresa.replace(/[^0-9+]/g, '').replace('+', '');
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bebas tracking-wider mb-4">CONTACTANOS</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            ¿Tienes alguna pregunta o necesitas ayuda? Estamos aqui para ayudarte
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-bold text-xl mb-4">Informacion de Contacto</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-medium text-sm text-gray-500 mb-1">Telefono / WhatsApp</div>
                    <a href={`tel:${telefonoEmpresa}`} className="text-gray-900 hover:text-blue-600">
                      {telefonoEmpresa}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${emailEmpresa}`} className="text-gray-900 hover:text-blue-600">
                      {emailEmpresa}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-medium text-sm text-gray-500 mb-1">Direccion</div>
            ...
            {/* Horario */}
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-bold text-xl mb-4">Horario de Atencion</h3>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-6 md:p-8">
              <h3 className="font-bold text-2xl mb-6">Envia tu mensaje</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Devolucion o cambio">Devolucion o cambio</option>
                ...
                <p className="text-xs text-gray-500 text-center">
                  Tambien puedes contactarnos directamente por WhatsApp para obtener una respuesta mas rapida
                </p>
              </form>
            </div>
          </div>
        ...
        <div className="mt-12 bg-white rounded-lg shadow-sm overflow-hidden">
          <div className="aspect-video">
            <iframe
              title={`Ubicacion de ${nombreEmpresa}`}
              src={mapEmbedUrl}
              width="100%"
              height="100%"
              style={{ border: 0 }}
