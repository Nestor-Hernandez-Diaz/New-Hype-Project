          ...
          <FormRow>
            <FormGroup>
              ...
              <PasswordWrapper>
                ...
                />
                <TogglePasswordButton type="button" onClick={() => setShowPassword(!showPassword)} tabIndex={-1}>
            ...
            <FormGroup>
              ...
              <PasswordWrapper>
                <Input
                  ...
                  style={{ paddingRight: '40px' }}
                />
                <TogglePasswordButton type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} tabIndex={-1}>
